...
@rem Run Bazel
CALL %SCRIPTDIR%bazel.cmd --max_idle_secs=60 test --keep_going --config=remote --build_tag_filters=-no_rbe_windows,-no_windows --test_tag_filters=-no_rbe_windows,%TESTTAGFILTERS% --profile=%DISTDIR%\prof --runs_per_test=5 -- %TARGETS%
