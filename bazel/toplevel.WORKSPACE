...
local_maven_repository(
  ...
  artifacts = [
    ...
    "com.google.testing.platform:android-device-provider-local::0.0.8-alpha06",
    "com.google.testing.platform:core-proto:0.0.8-alpha06",
    "com.google.testing.platform:launcher:0.0.8-alpha06",
    "com.google.truth:truth:0.44",
    "commons-io:commons-io:2.4",
    "commons-logging:commons-logging:1.2",
