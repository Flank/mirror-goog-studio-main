...
gcloud --project google.com:android-studio-alphasource builds submit --tag gcr.io/google.com/android-studio-alphasource/rbe-windows18036-as docker_windows
