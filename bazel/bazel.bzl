...
def _iml_module_jar_impl(
    ...
    # Resources.
    # Note: This section is ordered before the Java section below so that
    # manifest files found on disk take priority over the synthetic manifest
    # files generated by java_common.compile().
    if resources:
...
def _gen_split_tests(name, split_test_targets, test_tags = None, test_data = None, **kwargs):
    ...
    for split_name in split_test_targets:
        test_name = name + "_" + split_name + "_tests"
