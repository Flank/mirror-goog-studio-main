...
import com.android.tools.idea.wizard.template.impl.common.res.values.manifestStrings
...
fun RecipeExecutor.generateManifest(
  ...
  generateManifestStrings(activityClass, activityTitle, resOut, resOut, isNew, generateActivityTitle, isDynamicFeature)
