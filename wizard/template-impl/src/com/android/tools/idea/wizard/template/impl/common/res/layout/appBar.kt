 ...
 */
package com.android.tools.idea.wizard.template.impl.common.res.layout

import com.android.tools.idea.wizard.template.ThemesData
import com.android.tools.idea.wizard.template.getMaterialComponentName

fun appBarLayoutXml(
  useAndroidX: Boolean, useMaterial2: Boolean, packageName: String, activityClass: String, themesData: ThemesData, simpleLayoutName: String
): String {
 val coordinatorLayout = getMaterialComponentName("android.support.design.widget.CoordinatorLayout", useAndroidX)
 val appBarLayout = getMaterialComponentName("android.support.design.widget.AppBarLayout", useMaterial2)
