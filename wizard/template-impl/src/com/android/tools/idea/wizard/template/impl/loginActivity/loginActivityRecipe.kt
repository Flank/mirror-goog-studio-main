...
import com.android.tools.idea.wizard.template.impl.common.generateManifestStrings
import com.android.tools.idea.wizard.template.impl.common.generateThemeStyles
import com.android.tools.idea.wizard.template.impl.loginActivity.res.layout.activityLoginXml
import com.android.tools.idea.wizard.template.impl.loginActivity.res.values.dimensXml
import com.android.tools.idea.wizard.template.impl.loginActivity.res.values.stringsXml
import com.android.tools.idea.wizard.template.impl.loginActivity.androidManifestXml
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.data.loginDataSourceJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.data.loginDataSourceKt
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.data.loginRepositoryJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.data.loginRepositoryKt
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.data.model.loggedInUserJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.data.model.loggedInUserKt
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.data.resultJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.data.resultKt
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loggedInUserViewJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loggedInUserViewKt
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginActivityJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginActivityKt
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginFormStateJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginFormStateKt
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginResultJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginResultKt
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginViewModelFactoryJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginViewModelFactoryKt
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginViewModelJava
import com.android.tools.idea.wizard.template.impl.loginActivity.src.app_package.ui.login.loginViewModelKt
