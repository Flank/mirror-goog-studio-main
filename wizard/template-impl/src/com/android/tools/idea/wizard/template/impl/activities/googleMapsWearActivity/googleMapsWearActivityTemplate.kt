...
val googleMapsWearActivityTemplate
  get() = template {
    ...
    thumb { File("template_map_wear_activity.png") }

    recipe = { data: TemplateData ->
      googleMapsWearActivityRecipe(data as ModuleTemplateData, activityClass.value, layoutName.value, isLauncher.value, packageName.value)
    }
  }
