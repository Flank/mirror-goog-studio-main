...
fun getMaterialComponentName(mavenCoordinate: String, useAndroidX: Boolean): String {
  ...
  val mapping = mapOf(
    ...
    "android.support.v17.leanback.app.BrowseFragment" to "androidx.leanback.app.BrowseFragment",
    "android.support.v17.leanback.app.DetailsFragment" to "androidx.leanback.app.DetailsFragment",
    "android.support.v17.leanback.app.DetailsFragmentBackgroundController" to "androidx.leanback.app.DetailsFragmentBackgroundController",
    "android.support.v17.leanback.app.ErrorFragment" to "androidx.leanback.app.ErrorFragment",
