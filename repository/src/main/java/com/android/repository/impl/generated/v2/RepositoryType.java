 ...
 *
 * <p>The repository, consisting of a licenses and packages.
 *
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="license" type="{http://schemas.android.com/repository/android/common/02}licenseType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="channel" type="{http://schemas.android.com/repository/android/common/02}channelType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;choice&gt;
 *           &lt;element name="remotePackage" type="{http://schemas.android.com/repository/android/common/02}remotePackage" maxOccurs="unbounded" minOccurs="0"/&gt;
 *           &lt;element name="localPackage" type="{http://schemas.android.com/repository/android/common/02}localPackage" minOccurs="0"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
@XmlType(
        name = "repositoryType",
        propOrder = {"license", "channel", "remotePackage", "localPackage"})
...
public class RepositoryType extends Repository {
     ...
     * why there is not a <CODE>set</CODE> method for the license property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link LicenseType }
     */
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the channel property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link ChannelType }
     */
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the remotePackage property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link RemotePackage }
     */
     ...
     *
     * @return possible object is {@link LocalPackage }
     */
     ...
     *
     * @param value allowed object is {@link LocalPackage }
     */
