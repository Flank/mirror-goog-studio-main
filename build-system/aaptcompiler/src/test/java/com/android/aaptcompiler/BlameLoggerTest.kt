...
class BlameLoggerTest {
    ...
    fun rewriteSingleSource() {
        ...
        val result = blameLogger.getOriginalSource(BlameLogger.Source(File("foo/bar.xml"), 3, 5))
        assertThat(result.file.absolutePath).contains("bar.xml.rewritten")
    ...
    fun testsLoggedMessageRewritten() {
        ...
        blameLogger.error("Failed to read file", BlameLogger.Source(File("foo/bar.xml"), 3, 5))
