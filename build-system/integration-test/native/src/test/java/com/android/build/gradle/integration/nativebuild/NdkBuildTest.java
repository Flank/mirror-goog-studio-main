        ...
        assertThat(dump(fetchResult))
                .isEqualTo(
                        "[:]\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/ndkBuild/debug/arm64-v8a/additional_project_files.txt{!}\n"
                                + "          < abis\n"
                                + "       * NativeVariant:\n"
                                + "          * name = \"release\"\n"
                                + "          > abis:\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/ndkBuild/release/arm64-v8a/additional_project_files.txt{!}\n"
                                + "          < abis\n"
                                + "    < variants\n"
