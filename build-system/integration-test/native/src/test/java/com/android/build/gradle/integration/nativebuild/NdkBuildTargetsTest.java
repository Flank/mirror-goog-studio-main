        ...
        assertThat(dump(fetchResult))
                .isEqualTo(
                        "[:]\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/ndkBuild/debug/armeabi-v7a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86\"\n"
                                + "                * sourceFlagsFile                 = {PROJECT}/.cxx/ndkBuild/debug/x86/compile_commands.json.bin{F}\n"
                                + "                * symbolFolderIndexFile           = {PROJECT}/.cxx/ndkBuild/debug/x86/symbol_folder_index.txt{F}\n"
                                + "                * buildFileIndexFile              = {PROJECT}/.cxx/ndkBuild/debug/x86/build_file_index.txt{F}\n"
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/ndkBuild/debug/x86/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86_64\"\n"
                                + "                * sourceFlagsFile                 = {PROJECT}/.cxx/ndkBuild/debug/x86_64/compile_commands.json.bin{F}\n"
                                + "                * symbolFolderIndexFile           = {PROJECT}/.cxx/ndkBuild/debug/x86_64/symbol_folder_index.txt{F}\n"
                                + "                * buildFileIndexFile              = {PROJECT}/.cxx/ndkBuild/debug/x86_64/build_file_index.txt{F}\n"
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/ndkBuild/debug/x86_64/additional_project_files.txt{!}\n"
                                + "          < abis\n"
                                + "       * NativeVariant:\n"
                                + "          * name = \"release\"\n"
                                + "          > abis:\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/ndkBuild/release/armeabi-v7a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86\"\n"
                                + "                * sourceFlagsFile                 = {PROJECT}/.cxx/ndkBuild/release/x86/compile_commands.json.bin{!}\n"
                                + "                * symbolFolderIndexFile           = {PROJECT}/.cxx/ndkBuild/release/x86/symbol_folder_index.txt{!}\n"
                                + "                * buildFileIndexFile              = {PROJECT}/.cxx/ndkBuild/release/x86/build_file_index.txt{!}\n"
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/ndkBuild/release/x86/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86_64\"\n"
                                + "                * sourceFlagsFile                 = {PROJECT}/.cxx/ndkBuild/release/x86_64/compile_commands.json.bin{!}\n"
                                + "                * symbolFolderIndexFile           = {PROJECT}/.cxx/ndkBuild/release/x86_64/symbol_folder_index.txt{!}\n"
                                + "                * buildFileIndexFile              = {PROJECT}/.cxx/ndkBuild/release/x86_64/build_file_index.txt{!}\n"
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/ndkBuild/release/x86_64/additional_project_files.txt{!}\n"
                                + "          < abis\n"
                                + "    < variants\n"
