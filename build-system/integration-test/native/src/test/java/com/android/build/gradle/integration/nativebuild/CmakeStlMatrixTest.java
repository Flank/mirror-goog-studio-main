        ...
        assertThat(dump(result))
                .isEqualTo(
                        "[:]\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/cmake/release/armeabi-v7a/additional_project_files.txt{F}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86_64\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/cmake/release/x86_64/additional_project_files.txt{F}\n"
                                + "          < abis\n"
                                + "    < variants\n"
                                + "    - nativeBuildSystem       = CMAKE\n"
                                + "    - ndkVersion              = \"{DEFAULT_NDK_VERSION}\"\n"
