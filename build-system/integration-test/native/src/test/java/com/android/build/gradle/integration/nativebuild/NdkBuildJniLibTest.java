        ...
        assertThat(dump(fetchResult))
                .isEqualTo(
                        "[:lib]\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/ndkBuild/debug/armeabi-v7a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"arm64-v8a\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/ndkBuild/debug/arm64-v8a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/ndkBuild/debug/x86/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86_64\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/ndkBuild/debug/x86_64/additional_project_files.txt{!}\n"
                                + "          < abis\n"
                                + "       * NativeVariant:\n"
                                + "          * name = \"release\"\n"
                                + "          > abis:\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/ndkBuild/release/armeabi-v7a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"arm64-v8a\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/ndkBuild/release/arm64-v8a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/ndkBuild/release/x86/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86_64\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/ndkBuild/release/x86_64/additional_project_files.txt{!}\n"
                                + "          < abis\n"
                                + "    < variants\n"
