        ...
        assertThat(dump(fetchResult))
                .isEqualTo(
                        "[:lib]\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/{DEBUG}/armeabi-v7a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"arm64-v8a\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/{DEBUG}/arm64-v8a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/{DEBUG}/x86/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86_64\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/{DEBUG}/x86_64/additional_project_files.txt{!}\n"
                                + "          < abis\n"
                                + "       * NativeVariant:\n"
                                + "          * name = \"release\"\n"
                                + "          > abis:\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/{RELEASE}/armeabi-v7a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"arm64-v8a\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/{RELEASE}/arm64-v8a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/{RELEASE}/x86/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86_64\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/lib/.cxx/{RELEASE}/x86_64/additional_project_files.txt{!}\n"
                                + "          < abis\n"
                                + "    < variants\n"
