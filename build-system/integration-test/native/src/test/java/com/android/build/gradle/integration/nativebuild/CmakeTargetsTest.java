        ...
        assertThat(dump(result))
                .isEqualTo(
                        "[:]\n"
                                ...
                                + "             * NativeAbi:\n"
                                + "                * name                  = \"arm64-v8a\"\n"
                                + "                * sourceFlagsFile       = {PROJECT}/.cxx/cmake/debug/arm64-v8a/compile_commands.json{F}\n"
                                ...
                                + "             * NativeAbi:\n"
                                + "                * name                  = \"x86\"\n"
                                + "                * sourceFlagsFile       = {PROJECT}/.cxx/cmake/debug/x86/compile_commands.json{F}\n"
                                ...
                                + "             * NativeAbi:\n"
                                + "                * name                  = \"arm64-v8a\"\n"
                                + "                * sourceFlagsFile       = {PROJECT}/.cxx/cmake/release/arm64-v8a/compile_commands.json{!}\n"
                                ...
                                + "             * NativeAbi:\n"
                                + "                * name                  = \"x86\"\n"
                                + "                * sourceFlagsFile       = {PROJECT}/.cxx/cmake/release/x86/compile_commands.json{!}\n"
