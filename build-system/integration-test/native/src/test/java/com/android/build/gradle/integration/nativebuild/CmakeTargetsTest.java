        ...
        assertThat(dump(result))
                .isEqualTo(
                        "[:]\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/cmake/debug/armeabi-v7a/additional_project_files.txt{F}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"arm64-v8a\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/cmake/debug/arm64-v8a/additional_project_files.txt{F}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/cmake/debug/x86/additional_project_files.txt{F}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86_64\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/cmake/release/arm64-v8a/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86\"\n"
                                ...
                                + "                * additionalProjectFilesIndexFile = {PROJECT}/.cxx/cmake/release/x86/additional_project_files.txt{!}\n"
                                + "             * NativeAbi:\n"
                                + "                * name                            = \"x86_64\"\n"
