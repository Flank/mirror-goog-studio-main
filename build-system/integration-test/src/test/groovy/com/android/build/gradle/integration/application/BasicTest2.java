...
public class BasicTest2 {
    ...
    public void checkVariantDetails() throws Exception {
        ...
        assertEquals("Debug sourceGenTask", "generateDebugSources",
                debugMainInfo.getSourceGenTaskName());
        assertEquals("Debug compileTask", "compileDebugSources",
                debugMainInfo.getCompileTaskName());
        ...
        assertEquals("Test sourceGenTask", "generateDebugAndroidTestSources",
                debugTestInfo.getSourceGenTaskName());
        assertEquals("Test compileTask", "compileDebugAndroidTestSources",
        ...
        assertEquals("Release sourceGenTask", "generateReleaseSources",
                relMainInfo.getSourceGenTaskName());
        assertEquals("Release javaCompileTask", "compileReleaseSources",
                relMainInfo.getCompileTaskName());
