...
class NoCruncherTest {
    ...
    @Test
    void "test png files were not crunched by AAPT"() {
        ...
        File destFile = noPngCrunch
                .file("build/" + FD_INTERMEDIATES + "/res/merged/debug/drawable/icon.png")
        ...
        destFile = noPngCrunch
                .file("build/" + FD_INTERMEDIATES + "/res/merged/debug/drawable/lib_bg.9.png")
    ...
    @Test
    void "test png files were generated by AAPT2"() {
        ...
        File srcFile = noPngCrunch.file("src/main/res/drawable/icon.png")
        File destFile = noPngCrunch
                    .file("build/" + FD_INTERMEDIATES + "/res/merged/debug/drawable_icon.png.flat")
        ...
        srcFile = noPngCrunch.file("src/main/res/drawable/lib_bg.9.png")
        destFile = noPngCrunch
                .file("build/" + FD_INTERMEDIATES + "/res/merged/debug/drawable_lib_bg.9.png.flat")
