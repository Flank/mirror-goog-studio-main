...
public class ManifestMergingTest {
    ...
    public void checkManifestMergingForLibraries() throws Exception {
        ...
        fileOutput =
                libsTest.file(
                        "libapp/build/"
                                + FD_INTERMEDIATES
                                + "/merged_manifests/release/processReleaseManifest/merged/AndroidManifest.xml");
    ...
    public void checkTestOnlyAttribute() throws Exception {
        ...
        assertThat(
                        flavors.file(
                                "build/intermediates/merged_manifests/f1FaDebug/processF1FaDebugManifest/merged/AndroidManifest.xml"))
    ...
    public void checkManifestMergingWithNavigationFiles() throws Exception {
        ...
        File manifestFile =
                navigation.file(
                        "app/build/intermediates/merged_manifests/f1Debug/processF1DebugManifest/merged/AndroidManifest.xml");
