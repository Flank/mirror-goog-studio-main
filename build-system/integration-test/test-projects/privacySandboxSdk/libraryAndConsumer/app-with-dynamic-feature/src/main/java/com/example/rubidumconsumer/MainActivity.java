...
public class MainActivity extends AppCompatActivity {
    ...
    // Needs to be the package name of the SDK as defined in the SdkModulesConfig.pb.json when
    // building the SDK
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sdkSandboxManager = getApplicationContext().getSystemService(SdkSandboxManager.class);
    }
