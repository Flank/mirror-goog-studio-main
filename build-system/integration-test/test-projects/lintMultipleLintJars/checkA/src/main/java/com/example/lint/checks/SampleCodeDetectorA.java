 ...
 */
public class SampleCodeDetectorA extends Detector implements UastScanner {
    ...
    public static final Issue ISSUE =
            Issue.create(
                    ...
                    "A This check highlights string literals in code which mentions "
                    ...
                    6,
                    Severity.WARNING,
                    new Implementation(SampleCodeDetectorA.class, Scope.JAVA_FILE_SCOPE));
            ...
            public void visitLiteralExpression(ULiteralExpression expression) {
                ...
                if (string.contains("lint") && string.matches(".*\\blint\\b.*")) {
                    context.report(
                            ...
                            "A This code mentions `lint`: **Congratulations**");
                }
            }
        };
    }
