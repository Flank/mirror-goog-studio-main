...
open class BasicModuleModelMock {
    ...
    val externalNativeNdkBuildOptions = mock(
        com.android.build.gradle.internal.dsl.ExternalNativeNdkBuildOptions::class.java
    )
    val externalNativeCmakeOptions = mock(
        com.android.build.gradle.internal.dsl.ExternalNativeCmakeOptions::class.java
    )
    ...
    fun mockModule(appName : String) : File {
        ...
        doReturn(externalNativeNdkBuildOptions).`when`(coreExternalNativeBuildOptions).externalNativeNdkBuildOptions
    ...
    init {
            ...
            doReturn(setOf<String>()).`when`(externalNativeNdkBuildOptions).abiFilters
            doReturn(listOf<String>()).`when`(externalNativeNdkBuildOptions).arguments
            doReturn(listOf<String>()).`when`(externalNativeNdkBuildOptions).cFlags
            doReturn(listOf<String>()).`when`(externalNativeNdkBuildOptions).cppFlags
            doReturn(setOf<String>()).`when`(externalNativeNdkBuildOptions).targets
            doReturn(setOf<String>()).`when`(externalNativeCmakeOptions).abiFilters
            doReturn(listOf<String>()).`when`(externalNativeCmakeOptions).arguments
            doReturn(listOf<String>()).`when`(externalNativeCmakeOptions).cFlags
