...
class BuiltArtifactsLoaderImpl: BuiltArtifactsLoader {
    ...
    private fun loadFromFile(metadataFile: File?, relativePath: Path?): BuiltArtifacts? {
        ...
        val buildOutputs = gson.fromJson<BuiltArtifactsImpl>(reader, BuiltArtifactsImpl::class.java)
