...
public class GradleVariantConfiguration {
    ...
    @NonNull private final SourceProvider mDefaultSourceProvider;

    @NonNull private final BuildType mBuildType;
    /** SourceProvider for the BuildType. Can be null */
    @Nullable private final SourceProvider mBuildTypeSourceProvider;
    ...
    @Nullable private SourceProvider mVariantSourceProvider;

    /** MultiFlavors specific source provider, may be null */
    @Nullable private SourceProvider mMultiFlavorSourceProvider;

    @NonNull private final VariantType mType;
     ...
     */
    private final GradleVariantConfiguration mTestedConfig;
    ...
    @NonNull private final MergedNdkConfig mergedNdkConfig = new MergedNdkConfig();
    ...
    GradleVariantConfiguration(
            ...
            @Nullable GradleVariantConfiguration testedConfig,
     ...
     *
     * <p>The list contains the dimension names as well.
     *
     ...
     */
    public void setVariantSourceProvider(@Nullable SourceProvider sourceProvider) {
     ...
     * @return the config object
     */
    public void setMultiFlavorSourceProvider(@Nullable SourceProvider sourceProvider) {
     ...
     *
     * <p>The list is ordered from higher priority to lower priority.
     *
    ...
    @Nullable
    public GradleVariantConfiguration getTestedConfig() {
    ...
    public String getInstrumentationRunner() {
        GradleVariantConfiguration config = this;
        if (mType.isTestComponent()) {
    ...
    public AndroidVersion getMinSdkVersion() {
        ...
        if (minSdkVersion == null) {
            ...
            minSdkVersion = DefaultApiVersion.create(Integer.valueOf(1));
        }
    ...
    public ApiVersion getTargetSdkVersion() {
        ...
        if (targetSdkVersion == null) {
            ...
            targetSdkVersion = DefaultApiVersion.create(Integer.valueOf(-1));
        }
     ...
     */
    public void addBuildConfigField(
     ...
     *
     * <p>Items can be either fields (instance of {@link com.android.builder.model.ClassField}) or
     ...
     *
     * <p>This is made of the variant-specific fields overlaid on top of the build type ones, the
