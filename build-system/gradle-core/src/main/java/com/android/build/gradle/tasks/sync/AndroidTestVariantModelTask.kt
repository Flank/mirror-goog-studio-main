...
abstract class AndroidTestVariantModelTask:  AbstractVariantModelTask() {
    ...
    class CreationAction(creationConfig: AndroidTestCreationConfig):
        AbstractVariantModelTask.CreationAction<AndroidTestVariantModelTask, AndroidTestCreationConfig>(
            creationConfig = creationConfig,
        ) {

        override val type: Class<AndroidTestVariantModelTask>
            get() = AndroidTestVariantModelTask::class.java
    }
}
