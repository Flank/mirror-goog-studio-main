...
/**
 * A lot of internal code is expecting a [Artifact.Single] [Artifact] and it is not possible
...
abstract class SingleArtifactType<T : FileSystemLocation>(kind: ArtifactKind<T>)
    : Artifact<T>(kind), Artifact.Single

/** A type of output generated by a task.  */
@Suppress("ClassName")
sealed class
InternalArtifactType<T : FileSystemLocation>(kind: ArtifactKind<T>,
