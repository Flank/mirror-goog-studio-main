...
sealed class InternalArtifactType<T : FileSystemLocation>(kind: ArtifactKind<T>,
    ...
    object RUNTIME_LIBRARY_CLASSES: InternalArtifactType<RegularFile>(FILE), Replaceable
    ...
    object COMPILE_LIBRARY_CLASSES: InternalArtifactType<RegularFile>(FILE), Replaceable
    ...
    object DESUGAR_LIB_DEX: InternalArtifactType<RegularFile>(FILE), Replaceable
    // Keep rules generated by D8/R8, which are consumed by L8 to shrink the desugar_jdk_libs.jar
    object DESUGAR_LIB_PROJECT_KEEP_RULES: InternalArtifactType<Directory>(DIRECTORY)
