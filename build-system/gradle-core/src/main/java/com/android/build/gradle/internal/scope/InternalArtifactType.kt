...
sealed class InternalArtifactType<T : FileSystemLocation>(kind: ArtifactKind<T>,
    ...
    // Directory containing all ML model classes that are auto generated by the MLKIT task.
    object MLKIT_SOURCE_OUT: InternalArtifactType<Directory>(DIRECTORY, Category.GENERATED), Replaceable
