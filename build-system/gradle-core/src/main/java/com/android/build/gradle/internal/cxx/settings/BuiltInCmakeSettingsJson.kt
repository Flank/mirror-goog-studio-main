        ...
        .initialize(createCmakeSettingsJsonFromString("""
            {
                "configurations": [{
                    ...
                    "variables": [
                        ...
                        {"name": "$ANDROID_PLATFORM", "value": "${NDK_PLATFORM.ref}"},
                        {"name": "$CMAKE_ANDROID_ARCH_ABI", "value": "${NDK_ABI.ref}"},
                        {"name": "$CMAKE_ANDROID_NDK", "value": "${NDK_DIR.ref}"},
                        {"name": "$CMAKE_C_FLAGS", "value": "${NDK_C_FLAGS.ref}"},
                        {"name": "$CMAKE_CXX_FLAGS", "value": "${NDK_CPP_FLAGS.ref}"},
                        {"name": "$CMAKE_EXPORT_COMPILE_COMMANDS", "value": "ON"},
                        {"name": "$CMAKE_LIBRARY_OUTPUT_DIRECTORY", "value": "${NDK_DEFAULT_LIBRARY_OUTPUT_DIRECTORY.ref}"},
