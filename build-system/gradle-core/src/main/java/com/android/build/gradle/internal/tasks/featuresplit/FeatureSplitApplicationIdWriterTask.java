 ...
 */
public class FeatureSplitApplicationIdWriterTask extends BaseTask {
    ...
    public void fullTaskAction() throws IOException {
        FeatureSplitApplicationId declaration = new FeatureSplitApplicationId(applicationId);
        declaration.save(outputDirectory);
    }

    public static class ConfigAction
            implements TaskConfigAction<FeatureSplitApplicationIdWriterTask> {
        ...
        @NonNull
        @Override
        public Class<FeatureSplitApplicationIdWriterTask> getType() {
            return FeatureSplitApplicationIdWriterTask.class;
        }
