...
public interface BaseVariant {
     ...
     *
     * <p>This is typically used by compilers for languages that generate bytecode ahead of javac.
     *
     ...
     *
     * <p>The generated byte-code will be added to the java compilation task's classpath and will be
     * added to the transform pipeline as a {@link
     ...
     * allows each successive call to {@link #registerGeneratedBytecode(FileCollection)} to be
     * associated with a classpath containing everything <strong>before</strong> the added bytecode.
     *
