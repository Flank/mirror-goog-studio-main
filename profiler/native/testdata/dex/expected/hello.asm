...
method Hello.wrapTest(Base, int) : void
{
	...
	.local v1, "n", int
	   ...
	   14| invoke-virtual {v7}, java.lang.Object.getClass
	   17| move-result-object v7
	   18| invoke-virtual {v7}, java.lang.Class.getName
	   ...
	   28| move v7, v1
	   29| invoke-static {v7}, java.lang.Integer.valueOf
	   32| move-result-object v7
	   33| aput-object v7, v5, v6
	   35| invoke-virtual {v2,v3,v4}, java.io.PrintStream.printf
