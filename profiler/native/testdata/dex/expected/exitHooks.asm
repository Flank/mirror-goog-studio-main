...
method Target.test() : void
{
	...
	.line 44
	  ...
	  111| const/4 v2, #+1 (0x00000001 | 0.000000)
...
method Target.testInt(int) : int
{
	...
	.line 76
	    6| const/16 v2, #+123 (0x0000007b | 0.000000)
	    8| move v0, v2
Label_1:
	.end_local v0
	    9| return v0
Label_2:
	.line 73
	.restart_local v0
	   10| const/4 v2, #+1 (0x00000001 | 0.000000)
	   11| move v0, v2
	   12| goto Label_1
Label_3:
	.line 74
	   13| const/4 v2, #+2 (0x00000002 | 0.000000)
	   14| move v0, v2
	   15| goto Label_1
Label_4:
	.line 75
	   16| const/4 v2, #+3 (0x00000003 | 0.000000)
	   17| move v0, v2
	   18| goto Label_1
	.line 71
	   19| nop
...
method Target.testObject(boolean) : java.lang.Object
{
	...
	.line 51
	    ...
	    9| const/4 v4, #+0 (0x00000000 | 0.000000)
...
Label_2:
	.line 89
	   ...
	   21| const/4 v4, #+0 (0x00000000 | 0.000000)
...
method Tracer.onExit(double) : double
{
	...
	.local v0, "value", double
	    ...
	    5| const/4 v4, #+1 (0x00000001 | 0.000000)
...
method Tracer.onExit(int) : int
{
	...
	.local v0, "value", int
	   ...
	   11| const/4 v5, #+0 (0x00000000 | 0.000000)
	   12| move v6, v0
	...
	.line 19
	   23| move v1, v0
	   24| const/16 v2, #+10 (0x0000000a | 0.000000)
	   26| mul-int/lit8 v1, v1, #+10 (0x0000000a | 0.000000)
	   28| move v0, v1
	.end_local v0
	   29| return v0
}
