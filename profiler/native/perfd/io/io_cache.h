...
class IoCache final {
 public:
  ...
  SessionDetails* AddSession(int32_t app_id, int64_t session_id,
  ...
  // check for |nullptr|.
  SessionDetails* GetDetails(int32_t app_id, int64_t session_id);
  ...
  // order.
  std::vector<SessionDetails> GetRange(int32_t app_id, int64_t start_timestamp,
