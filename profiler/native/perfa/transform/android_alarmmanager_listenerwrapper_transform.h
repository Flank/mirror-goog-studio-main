 ...
 */
#ifndef ANDROID_ALARMMANAGER_LISTENERWRAPPER_TRANSFORM_H
#define ANDROID_ALARMMANAGER_LISTENERWRAPPER_TRANSFORM_H
...
class AndroidAlarmManagerListenerWrapperTransform : public Transform {
 public:
  AndroidAlarmManagerListenerWrapperTransform()
      : Transform("Landroid/app/AlarmManager$ListenerWrapper;") {}
...
#endif  // ANDROID_ALARMMANAGER_LISTENERWRAPPER_TRANSFORM_H
