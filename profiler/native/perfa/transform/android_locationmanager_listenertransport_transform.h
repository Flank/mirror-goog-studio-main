 ...
 */
#ifndef ANDROID_LOCATIONMANAGER_LISTENERTRANSPORT_TRANSFORM_H
#define ANDROID_LOCATIONMANAGER_LISTENERTRANSPORT_TRANSFORM_H
...
class AndroidLocationManagerListenerTransportTransform : public Transform {
 public:
  AndroidLocationManagerListenerTransportTransform()
      : Transform("Landroid/location/LocationManager$ListenerTransport;") {}
...
#endif  // ANDROID_LOCATIONMANAGER_LISTENERTRANSPORT_TRANSFORM_H
