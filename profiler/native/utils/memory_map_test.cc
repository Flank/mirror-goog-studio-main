...
TEST(MemoryMapTest, ReadRealMap) {
  ...
  auto expected_regions = {
      ...
      MemoryRegion{"/dev/ashmem/dalvik-main space (region space) (deleted)",
                   0x12c00000, 0x12dc0000, 0x00000000},
      MemoryRegion{"/dev/ashmem/dalvik-main space (region space) (deleted)",
                   0x12dc0000, 0x13480000, 0x001c0000},
      MemoryRegion{"/dev/ashmem/dalvik-main space (region space) (deleted)",
                   0x13480000, 0x13740000, 0x00880000},
      MemoryRegion{"/dev/ashmem/dalvik-main space (region space) (deleted)",
                   0x13740000, 0x13800000, 0x00b40000},
      MemoryRegion{"/dev/ashmem/dalvik-main space (region space) (deleted)",
                   0x13800000, 0x14140000, 0x00c00000},
      MemoryRegion{"/dev/ashmem/dalvik-main space (region space) (deleted)",
                   0x14140000, 0x52c00000, 0x01540000},
      ...
      MemoryRegion{"/dev/ashmem/dalvik-zygote space (deleted)", 0x72313000,
                   0x723a3000, 0x00000000},
      MemoryRegion{"/dev/ashmem/dalvik-non moving space (deleted)", 0x723a3000,
                   0x723a4000, 0x00000000},
      MemoryRegion{"/dev/ashmem/dalvik-non moving space (deleted)", 0x723a4000,
                   0x723b6000, 0x00001000},
      MemoryRegion{"/dev/ashmem/dalvik-non moving space (deleted)", 0x723b6000,
                   0x75b14000, 0x00013000},
      MemoryRegion{"/dev/ashmem/dalvik-non moving space (deleted)", 0x75b14000,
                   0x76313000, 0x03771000},
      MemoryRegion{
          "/dev/ashmem/dalvik-/data/app/"
          "com.eugene.sum-9OdJq78uzWm2qWAzveNyHA==/oat/arm/base.art (deleted)",
