...
/**
 * This class wraps {@link RandomAccessFile} class constructors, these constructors are called via
...
public class RandomAccessFileWrapper {
    ...
    public static RandomAccessFile wrapRandomAccessFileConstructor(String name, String mode)
        throws FileNotFoundException {
        return new RandomAccessFile$(name, mode);
    }

    @SuppressWarnings("unused") // Called in the ProfilerPlugin via reflection
    public static RandomAccessFile wrapRandomAccessFileConstructor(File file, String mode)
        throws FileNotFoundException {
