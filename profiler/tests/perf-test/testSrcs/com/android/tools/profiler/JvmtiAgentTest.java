...
public class JvmtiAgentTest {
    ...
    public void attachAgentOnInvalidApi_ThrowsRuntimeException() throws Exception {
        ...
        thrown.expect(hasProperty("status", hasProperty("code", is(Status.Code.UNIMPLEMENTED))));
        grpc.getProfilerStub().beginSession(requestBuilder.build());
    }
}
