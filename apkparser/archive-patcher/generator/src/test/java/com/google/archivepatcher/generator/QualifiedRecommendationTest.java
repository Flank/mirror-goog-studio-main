...
public class QualifiedRecommendationTest {
    ...
    private static final MinimalZipEntry ENTRY1 =
            new MinimalZipEntry(0, 1, 2, 3, FILENAME1, true, 0);
    private static final MinimalZipEntry ENTRY2 =
            new MinimalZipEntry(1, 2, 3, 4, FILENAME2, true, 0);
    ...
    public void testEquals() {
        ...
        Assert.assertEquals(
                DEFAULT_QUALIFIED_RECOMMENDATION, CLONED_DEFAULT_QUALIFIED_RECOMMENDATION);
    ...
    public void testGetters() {
        ...
        Assert.assertEquals(
                Recommendation.UNCOMPRESS_BOTH,
                DEFAULT_QUALIFIED_RECOMMENDATION.getRecommendation());
        Assert.assertEquals(
                RecommendationReason.COMPRESSED_BYTES_CHANGED,
