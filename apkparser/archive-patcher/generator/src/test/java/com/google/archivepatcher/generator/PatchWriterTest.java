...
public class PatchWriterTest {
    ...
    public void testWriteV1Patch() throws IOException {
        ...
        Assert.assertEquals(
                1, patchIn.readInt()); // Number of old archive uncompression instructions
        ...
        Assert.assertEquals(
                1, patchIn.readInt()); // Number of new archive recompression instructions
