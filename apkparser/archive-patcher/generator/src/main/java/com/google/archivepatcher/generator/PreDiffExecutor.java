...
public class PreDiffExecutor {
    ...
    public static final class Builder {
        ...
        /**
         * Sets the output files that will hold the delta-friendly intermediate binaries used in
         * patch generation. If called, both arguments must be non-null.
         *
         * @param deltaFriendlyOldFile the intermediate file to write (will be overwritten if it
         *     exists)
         * @param deltaFriendlyNewFile the intermediate file to write (will be overwritten if it
         *     exists)
         * @return this builder
         */
        public Builder writingDeltaFriendlyFiles(
                File deltaFriendlyOldFile, File deltaFriendlyNewFile) {
        ...
        /**
         * Appends an optional {@link RecommendationModifier} to be used during the generation of
    ...
    /**
     * Optional file to write the delta-friendly version of the original old file to (will be
     * created, overwriting if it already exists). If null, only the read-only planning step can be
     * performed.
     */
    private final File deltaFriendlyOldFile;

    /**
     * Optional file to write the delta-friendly version of the original new file to (will be
     * created, overwriting if it already exists). If null, only the read-only planning step can be
     * performed.
     */
     ...
     */
    private List<TypedRange<JreDeflateParameters>> generateDeltaFriendlyFiles(
            PreDiffPlan preDiffPlan) throws IOException {
