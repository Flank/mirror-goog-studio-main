...
/**
 * An algorithm that performs a suffix sort on a given input and returns a suffix array. See
 * https://en.wikipedia.org/wiki/Suffix_array
 */
public interface SuffixSorter {

    /**
     * Perform a "suffix sort". Note: the returned {@link RandomAccessObject} should be closed by
     * the caller.
     *
