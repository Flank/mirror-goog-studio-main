...
/**
 * Interface which offers random access interface. This class exists to allow BsDiff to use either a
 * RandomAccessFile for disk-based io, or a byte[] for fully in-memory operation.
 */
public interface RandomAccessObject extends DataInput, DataOutput, Closeable {
    ...
    /**
     * Seek to a specified integer-aligned position in the associated file or byte array. For
     * example, seekToIntAligned(5) will seek to the beginning of the 5th integer, or in other words
     * the 20th byte. In general, seekToIntAligned(n) will seek to byte 4n.
     *
     * @param pos the position to seek to
     * @throws IOException if seeking fails
     */
    ...
    public static final class RandomAccessFileObject extends RandomAccessFile
        ...
        /**
         * This constructor takes in a temporary file. This constructor does not take ownership of
         * the file, and the file will not be deleted on {@link #close()}.
         *
         ...
         * @param tempFile the file backing this object
         * @param mode the mode to use, e.g. "r" or "w" for read or write
         * @param deleteFileOnClose if true the constructor takes ownership of that file, and this
        ...
        public RandomAccessFileObject(
                final File tempFile, final String mode, boolean deleteFileOnClose)
                throws IOException {
            super(tempFile, mode);
         ...
         * constructor. This should be called on every RandomAccessObject when it is no longer
         * needed.
         */
        // TODO(hartmanng): rethink the handling of these temp files. It's confusing and shouldn't
        // really be the responsibility of RandomAccessObject.
    ...
    /**
     * An array-based implementation of {@link RandomAccessObject} for entirely in-memory
     * operations.
     */
    ...
    public static final class RandomAccessMmapObject extends RandomAccessByteArrayObject {
        ...
        public RandomAccessMmapObject(final String tempFileName, final String mode, long length)
            ...
            if (length > Integer.MAX_VALUE) {
                throw new IllegalArgumentException(
                        "RandomAccessMmapObject only supports file sizes up to "
                                + "Integer.MAX_VALUE.");
            }
        ...
        /**
         * This constructor takes in a temporary file, and takes ownership of that file. This file
         * is deleted on close() OR IF THE CONSTRUCTOR FAILS. The main purpose of this constructor
         * is to test close() on the passed-in file.
         *
