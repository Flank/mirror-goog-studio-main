...
class BsUtil {
     ...
     *     in the first array, positive if the first difference has a lower value in the second
     *     array. If both arrays compare equal until one of them ends, the shorter sequence is
