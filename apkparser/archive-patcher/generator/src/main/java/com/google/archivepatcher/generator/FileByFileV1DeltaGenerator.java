...
public class FileByFileV1DeltaGenerator implements DeltaGenerator {
     ...
     *
     * @param recommendationModifiers optionally, {@link RecommendationModifier}s to use for
     ...
     * OutputStream}. The written patch is <em>raw</em>, i.e. it has not been compressed.
        ...
        try (TempFileHolder deltaFriendlyOldFile = new TempFileHolder();
            ...
            PreDiffExecutor.Builder builder =
                    new PreDiffExecutor.Builder()
                            ...
                            .writingDeltaFriendlyFiles(
                                    deltaFriendlyOldFile.file, deltaFriendlyNewFile.file);
