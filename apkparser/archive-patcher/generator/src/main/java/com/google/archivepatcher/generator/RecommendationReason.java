...
public enum RecommendationReason {
    /**
     * The entry in the new file is compressed in a way that cannot be reliably reproduced (or one
     * of the entries is compressed using something other than deflate, but this is very uncommon).
     */
    UNSUITABLE,
