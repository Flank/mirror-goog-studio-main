 ...
 * uncompression plan.
 *
 * <p>Finally, a {@link List} of all the {@link QualifiedRecommendation}s upon which all the plans
 * are based is available via {@link #getQualifiedRecommendations()}.
 */
public class PreDiffPlan {
     ...
     * @param oldFileUncompressionPlan the plan for uncompressing the old file, in file order
     * @param newFileUncompressionPlan the plan for uncompressing the new file, in file order
     * @param deltaFriendlyNewFileRecompressionPlan the plan for recompression the delta-friendly
