 ...
 *
 * <p>Every call to one of the write(...) methods results in reading the same total number of bytes
...
public class MatchingOutputStream extends OutputStream {
     ...
     *
     * @throws IOException if the end-of-file has not yet been reached in the associated {@link
     *     InputStream}
     */
