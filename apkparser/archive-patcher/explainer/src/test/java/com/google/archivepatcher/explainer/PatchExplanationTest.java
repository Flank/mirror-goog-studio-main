...
public final class PatchExplanationTest {
    ...
    private static final long EXPECTED_NEW_SIZE =
            EXPLANATION_1_NEW.getCompressedSizeInPatch()
                    + EXPLANATION_2_NEW.getCompressedSizeInPatch();
    ...
    private static EntryExplanation makeExplanation(
        ...
        try {
            ...
            return new EntryExplanation(
                    pathHolder, isNew, reasonIncludedIfNotNew, compressedSizeInPatch);
    ...
    public void testConstructor_Simple() {
        ...
        Assert.assertEquals(
                EXPECTED_CHANGED_EXPLANATIONS, patchExplanation.getExplainedAsChanged());
        Assert.assertEquals(
                EXPECTED_UNCHANGED_OR_FREE_EXPLANATIONS,
                patchExplanation.getExplainedAsUnchangedOrFree());
    ...
    public void testToJson() throws IOException {
        ...
        try (ByteArrayOutputStream buffer = new ByteArrayOutputStream();
            ...
            for (EntryExplanation explanation : ALL_EXPLANATIONS) {
                Assert.assertTrue(
                        asString.contains(new String(explanation.getPath().getData(), "UTF-8")));
            }
