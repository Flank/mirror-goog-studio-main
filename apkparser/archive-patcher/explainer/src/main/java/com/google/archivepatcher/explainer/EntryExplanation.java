...
public class EntryExplanation {
    ...
    /**
     * Returns the <strong>approximate</strong> size of the entry in the patch stream. This number
     * is <strong>not</strong> guaranteed to be precise. Patch generation is complex, and in some
     * cases the patching process may use arbitrary bytes from arbitrary locations in the old
     * archive to populate bytes in the new archive. Other factors may also contribute to
     * inaccuracies, such as overhead in the patch format itself or in compression technology,
     * etceteras.
     *
     * @return as described
     */
