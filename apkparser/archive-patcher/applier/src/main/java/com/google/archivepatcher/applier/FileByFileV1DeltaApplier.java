...
public class FileByFileV1DeltaApplier implements DeltaApplier {
    ...
    /**
     * Creates a new delta applier that will use the default temp directory for working files. This
     * is equivalent to calling {@link #FileByFileV1DeltaApplier(File)} with a <code>null</code>
     * file argument.
     */
    ...
    /**
     * Return an instance of a {@link DeltaApplier} suitable for applying the deltas within the
     * patch stream.
     *
     * @return the applier
     */
