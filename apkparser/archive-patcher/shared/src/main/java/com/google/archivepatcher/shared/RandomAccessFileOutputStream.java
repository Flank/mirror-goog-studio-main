...
/**
 * An {@link OutputStream} backed by a file that will be written serially. Allows pre-allocating the
 * space for a stream as a file and then writing to that file as a stream. Call {@link #flush()} to
 * force the data to be written to the backing storage.
 */
public class RandomAccessFileOutputStream extends OutputStream {
     ...
     * @param expectedSize if greater than or equal to zero, the size to set the file to
     *     immediately; otherwise, the file size is not set
