...
public class DeflateCompressor implements Compressor {
    ...
    /**
     * Whether or not to suppress wrapping the deflate output with the standard zlib header and
     * checksum fields. Defaults to true.
     */
    private boolean nowrap = true;

    /**
     * The size of the buffer used for reading data in during {@link #compress(InputStream,
     * OutputStream)}.
     */
    private int inputBufferSize = 32768;

    /**
     * The size of the buffer used for writing data out during {@link #compress(InputStream,
     * OutputStream)}.
     */
    ...
    /**
     * Sets the strategy that will be used. Valid values can be found in {@link Deflater}. Defaults
     * to {@link Deflater#DEFAULT_STRATEGY}
     *
    ...
    /**
     * Returns the size of the buffer used for reading from the input stream in {@link
    ...
    /**
     * Sets the size of the buffer used for reading from the input stream in {@link
     * #compress(InputStream, OutputStream)}.
     *
    ...
    /**
     * Returns the size of the buffer used for writing to the output stream in {@link
     * #compress(InputStream, OutputStream)}.
     *
     * @return the size (default is 32768)
     */
    ...
    /**
     * Sets the size of the buffer used for writing to the output stream in {@link
     * #compress(InputStream, OutputStream)}. NB: {@link Deflater} uses an <em>internal</em> buffer
     * and this method adjusts the size of that buffer. This buffer is important for performance,
     * <em>even if the {@link OutputStream} is is already buffered</em>.
     *
    ...
    /**
     * Sets whether or not to cache the {@link Deflater} instance. Defaults to false. If set to
     * true, the {@link Deflater} is kept until this object is finalized or until {@link #release()}
     * is called. Instances of {@link Deflater} can be surprisingly expensive, so caching is advised
     * in situations where many resources need to be deflated.
     *
