...
public interface MultiViewInputStreamFactory<T extends InputStream> {
    /**
     * Create and return a new {@link InputStream}. The returned stream is guaranteed to
     * independently produce the same byte sequence as any other stream obtained via a call to this
     * method on the same instance of this object.
     *
     * @return the stream
