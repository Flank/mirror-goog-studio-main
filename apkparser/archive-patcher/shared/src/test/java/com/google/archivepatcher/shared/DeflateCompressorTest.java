...
public class DeflateCompressorTest {
    /**
     * Test data for compression. Uses the {@link DefaultDeflateCompatibilityWindow}'s corpus
     * because it is already set up to produce different outputs for each compression level.
     */
    private static final byte[] CONTENT = new DefaultDeflateCompatibilityWindow().getCorpus();
    ...
    /**
     * Uncompress some content with Java's built-in {@link Inflater} as a sanity check against our
     * own code.
     *
    ...
    public void testCompress() throws IOException {
        ...
        byte[] uncompressed =
                uncompressWithJavaInflater(
                        compressor.isNowrap(), compressedContentOut.toByteArray());
