...
public class ArchiveTreeStructureTest {
    ...
    public void create() throws IOException {
        String actual = dumpTree(root, n -> n.getData().getPath().toString());
        String expected =
                "/\n"
                        + "/res/\n"
                        + "/res/anim/\n"
    ...
    public void updateRawFileSizes() throws IOException {
        ArchiveTreeStructure.updateRawFileSizes(
                root, ApkSizeCalculator.getDefault(archive.getPath()));
        String actual =
                dumpTree(
                        root,
                        n -> {
    ...
    public void updateDownloadFileSizes() throws IOException {
        ...
        ArchiveTreeStructure.updateDownloadFileSizes(
                root, ApkSizeCalculator.getDefault(archive.getPath()));
