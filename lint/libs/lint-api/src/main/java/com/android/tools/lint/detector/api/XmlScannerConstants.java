...
public interface XmlScannerConstants {
    /**
     * Special marker collection returned by {@link XmlScanner#getApplicableElements()} or
     * {@link XmlScanner#getApplicableAttributes()} to indicate that the check should be
