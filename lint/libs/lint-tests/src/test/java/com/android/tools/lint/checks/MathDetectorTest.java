...
public class MathDetectorTest extends AbstractCheckTest {
    ...
    private final TestFile mTestFile =
            java(
                    "src/test/bytecode/MathTest.java",
                    ""
    ...
    public int getHighestTargetSmallerThan(int max) {
        ...
        for (int i = targets.length - 1; i >= 0; i--) {
            ...
            if (target.getVersion().getApiLevel() < max && target.isPlatform()) {
    ...
    public void testNoWarningsPreFroyo() {
