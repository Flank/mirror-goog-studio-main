    ...
    public void testArraySizes() {
        String expected =
                ""
                        ...
                        + "0 errors, 2 warnings\n";
        lint().files(mArrays, mArrays2, mArrays3, mArrays4, mStrings).run().expect(expected);
    }
    ...
    public void testArraySizesIncremental() throws Exception {
        assertEquals(
                ...
                lintProjectIncrementally(
                        "res/values/arrays.xml", mArrays, mArrays2, mArrays3, mArrays4, mStrings));
    }

    @SuppressWarnings("all") // Sample code
    private TestFile mArrays =
            xml(
