...
public class JobSchedulerDetectorTest extends AbstractCheckTest {
    ...
    public void testOk() {
        lint().files(VALID_SERVICE_REFERENCE, MY_JOB_SERVICE, NOT_A_JOB_SERVICE, VALID_MANIFEST)
                .run()
                .expectClean();
    }
    ...
    public static final TestFile MY_JOB_SERVICE =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    public static final TestFile NOT_A_JOB_SERVICE =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    public static final TestFile VALID_SERVICE_REFERENCE =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    public static final TestFile VALID_MANIFEST =
            manifest(
                    ""
                            + "<manifest xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
                            + "    package=\"test.pkg\">\n"
