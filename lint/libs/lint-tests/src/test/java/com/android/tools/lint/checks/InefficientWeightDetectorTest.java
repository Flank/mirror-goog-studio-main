...
public class InefficientWeightDetectorTest extends AbstractCheckTest {
    ...
    public void testWeights() throws Exception {
        ...
        assertEquals(""
                ...
                + "      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                + "1 errors, 2 warnings\n",
            lintFiles(xml("res/layout/inefficient_weight.xml", ""
    ...
    public void testWeights2() throws Exception {
        ...
        assertEquals(""
                ...
                + "            ~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                + "0 errors, 1 warnings\n",
            lintFiles(xml("res/layout/nested_weights.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    ...
    public void testWeights3() throws Exception {
        ...
        assertEquals(""
                ...
                + "^\n"
                + "0 errors, 1 warnings\n",
            lintFiles(xml("res/layout/baseline_weights.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
                            + "    android:layout_width=\"match_parent\"\n"
                            + "    android:layout_height=\"match_parent\"\n"
    ...
    public void testWeights4() throws Exception {
        ...
        assertEquals(""
                ...
                + "^\n"
                + "0 errors, 1 warnings\n",
            lintFiles(xml("res/layout/activity_item_two_pane.xml", ""
                            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
    ...
    public void testNoVerticalWeights3() throws Exception {
        ...
        assertEquals(
            "No warnings.",
            lintFiles(xml("res/layout/baseline_weights2.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
                            + "    android:layout_width=\"match_parent\"\n"
                            + "    android:layout_height=\"match_parent\"\n"
    ...
    public void testNoVerticalWeights4() throws Exception {
        ...
        assertEquals(""
                ...
                + "^\n"
                + "0 errors, 1 warnings\n",
            lintFiles(xml("res/layout/baseline_weights3.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
                            + "    android:layout_width=\"match_parent\"\n"
                            + "    android:layout_height=\"match_parent\" >\n"
    ...
    public void testSuppressed() throws Exception {
        ...
        assertEquals(
            ...
            lintFiles(xml("res/layout/inefficient_weight2.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<LinearLayout\n"
                            + "    xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
                            + "    xmlns:tools=\"http://schemas.android.com/tools\"\n"
    ...
    public void testNestedWeights() throws Exception {
        ...
        assertEquals(
                ...
                lintFiles(xml("res/layout/nested_weights2.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    ...
    public void testWrong0Dp() throws Exception {
        ...
        assertEquals(""
            ...
            lintFiles(xml("res/layout/wrong0dp.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<FrameLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
                            + "    xmlns:tools=\"http://schemas.android.com/tools\"\n"
                            + "    android:layout_width=\"match_parent\"\n"
    ...
    public void testOrientation() throws Exception {
        ...
        assertEquals(""
                ...
                lintFiles(xml("res/layout/orientation.xml", ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<!--\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mStyles_inherited_orientation = xml("res/values/styles-inherited-orientation.xml", ""
