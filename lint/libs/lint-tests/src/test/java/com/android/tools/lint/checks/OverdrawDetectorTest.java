...
public class OverdrawDetectorTest extends AbstractCheckTest {
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mFourthActivity =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mOverdrawActivity =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mSecondActivity =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mThirdActivity =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
