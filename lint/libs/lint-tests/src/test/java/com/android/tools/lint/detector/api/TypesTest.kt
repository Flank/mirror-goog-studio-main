    ...
    fun testJavaEnums() {
        ...
        assertEquals(
            "" +
                ...
                "            UBlockExpression [{...}]\n" +
                "        UMethod (name = values) [public static fun values() : test.pkg.JavaEnum[] = UastEmptyExpression]\n" +
                "        UMethod (name = valueOf) [public static fun valueOf(name: java.lang.String) : test.pkg.JavaEnum = UastEmptyExpression]\n" +
