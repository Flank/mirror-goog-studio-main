    ...
    public void testFormattingCharSuggestions() {
        String expected =
                ""
                        ...
                        + "    <string name=\"key1\">%s</string>\n"
                        + "    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "src/test/pkg/FormatSuggestions.java:16: Error: Suspicious argument type for formatting argument #1 in key1: conversion is s, received Float (argument #2 in method call) (Did you mean formatting character d, 'o' or x?) [StringFormatMatches]\n"
                        + "        resources.getString(R.string.key1, new Float(3.14f));\n"
                        + "                                           ~~~~~~~~~~~~~~~~\n"
                        + "    res/values/strings.xml:3: Conflicting argument declaration here\n"
                        + "    <string name=\"key1\">%s</string>\n"
                        + "    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "src/test/pkg/FormatSuggestions.java:17: Error: Suspicious argument type for formatting argument #1 in key1: conversion is s, received Double (argument #2 in method call) (Did you mean formatting character d, 'o' or x?) [StringFormatMatches]\n"
