...
public class PxUsageDetectorTest extends AbstractCheckTest {
    ...
    public void testPx() throws Exception {
        ...
        assertEquals(""
                ...
                + "        ~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                + "0 errors, 3 warnings\n",
            lintFiles(xml("res/layout/now_playing_after.xml", ""
    ...
    public void testSp() throws Exception {
        ...
        assertEquals(""
            ...
            lintFiles(xml("res/layout/textsize.xml", ""
                            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
    ...
    public void testStyles() throws Exception {
        ...
        assertEquals(""
            ...
            lintFiles(xml("res/values/pxsp.xml", ""
                            + "<resources>\n"
                            + "    <style name=\"Style1\">\n"
    ...
    public void testBatchDimensions() throws Exception {
        assertEquals(""
                ...
                + "0 errors, 1 warnings\n",
            lintFiles(mDimens, mTextsize2));
    }

    @SuppressWarnings("all") // Sample code
    private TestFile mDimens = xml("res/values/dimens.xml", ""
            + "<resources>\n"
            + "    <dimen name=\"bottom_bar_portrait_button_font_size\">16dp</dimen>\n"
            + "</resources>\n");

    @SuppressWarnings("all") // Sample code
    private TestFile mTextsize2 = xml("res/layout/textsize2.xml", ""
            + "<LinearLayout xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
            + "    xmlns:tools=\"http://schemas.android.com/tools\"\n"
            + "    android:id=\"@+id/LinearLayout1\"\n"
            + "    android:layout_width=\"match_parent\"\n"
