...
public class FieldGetterDetectorTest extends AbstractCheckTest {
        ...
        lint().files(
                        ...
                        java(
                                ""
                                        ...
                                        + "}\n"),
                        base64gzip(
                                "bin/classes/test/pkg/TestFieldGetter.class",
                                ""
    ...
    private TestFile mClasspath_jar =
            source(
                    ".classpath",
                    ""
    ...
    private TestFile mGetterTest2 =
            base64gzip(
                    "bin/classes/test/bytecode/GetterTest.class",
                    ""
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mGetterTest5 =
            base64gzip(
                    "bin/test/pkg/bogus.class",
                    ""
                            + "H4sIAAAAAAAAAAvwZmYRYeAAQoFoOwcGJMDJwMLg6xriqOvp56b/7xQDAzND"
                            + "gDc7B0iKCaokAKdmESCGa/Z19PN0cw0O0fN1++x75rSPt67eRV5vXa1zZ85v"
                            + "DjK4YvzgaZGel6+Op+/F0lUsnDNeSh6RjtTKsBATebJEq+KZ6uvMT0UfixjB"
