...
public class HtmlReporterTest extends AbstractCheckTest {
    public void testBasic() throws Exception {
        ...
        try {
            ...
            Warning warning3 = new Warning(HardcodedValuesDetector.ISSUE,
                    "Hardcoded string \"Bar\", should use @string resource",
                    Severity.WARNING, project);
            warning3.line = 0;
            warning3.file = main;
            warning3.path = "res/layout/main.xml";
            warning3.fileContents = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
            ...
            Warning warning4 = new Warning(IconDetector.DUPLICATES_NAMES,
