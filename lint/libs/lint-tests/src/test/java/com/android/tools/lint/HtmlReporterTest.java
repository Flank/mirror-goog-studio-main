...
public class HtmlReporterTest extends AbstractCheckTest {
    public void testBasic() throws Exception {
        ...
        try {
            ...
            ImageTestFile icon1 =
                    new ImageTestFile("res/drawable-mdpi/icon.png", 100, 100).fill(0xFFFF00FF);
            ImageTestFile icon2 =
                    new ImageTestFile("res/drawable-340dpi/icon2.png", 100, 100).fill(0xFFFF00FF);
            ImageTestFile icon3 =
                    new ImageTestFile("res/drawable-260dpi/icon3.png", 100, 100).fill(0xFFFF00FF);
            ImageTestFile icon4 =
                    new ImageTestFile("res/drawable-xxhdpi/icon4.png", 100, 100).fill(0xFFFF00FF);
            ...
            Warning warning3 =
                    new Warning(
                            HardcodedValuesDetector.ISSUE,
                            "Hardcoded string \"Bar\", should use @string resource",
                            Severity.WARNING,
                            project);
            warning3.line = 0;
            warning3.file = main;
            warning3.path = "res/layout/main.xml";
            warning3.fileContents =
                    "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            ...
                            + "            android:id=\"@+id/foo\" />\n"
                            + "</LinearLayout>\n";
            // Invalid location: Missing positions.
            ...
            Warning warning4 =
                    new Warning(
                            ...
                            Severity.WARNING,
                            project);
            warning4.file = location1.getFile();
            warning4.path = icon1.targetRelativePath;
            warning4.location = location1;
            ...
            assertEquals(
                    ""
                            ...
                            + "<span class=\"location\"><a href=\"res/layout/main.xml\">res/layout/main.xml</a>:1</span>: <span class=\"message\">Hardcoded string \"Bar\", should use @string resource</span><br />\n"
                            + "</div>\n"
