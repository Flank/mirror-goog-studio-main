...
public class IconDetectorTest extends AbstractCheckTest {
    ...
    private static final Issue[] ALL_ISSUES =
            new Issue[] {
    ...
    public void test2() {
        ...
        lint().files(
                        ...
                        image("res/drawable-hdpi/appwidget_bg_focus.9.png", 49, 49)
                                .fill(0xFF00FF29),
                        image("res/drawable-hdpi/other.9.png", 48, 48).fill(0xFF00FF29),
                        image("res/drawable-hdpi/ic_launcher.png", 72, 72)
                                .fill(10, 10, 20, 20, 0x00000000),
                        image("res/drawable-hdpi/unrelated.png", 72, 72)
                                .fill(10, 10, 20, 20, 0x00000000))
                .issues(ALL_ISSUES)
                .run()
                .expect(expected);
    ...
    public void testNoDpi2() {
        ...
        lint().files(
                        image("res/drawable-mdpi/frame.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/drawable-hdpi/frame.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/drawable-ldpi/frame.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/drawable-xhdpi/frame.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/drawable-xxhdpi/frame.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/drawable-xxxhdpi/frame.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/drawable-nodpi/file1.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/drawable-nodpi/file2.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000))
                .issues(ALL_ISSUES)
                .run()
    ...
    public void testNoWarningForMipmapsOnly() {
        ...
        lint().files(
                        ...
                        image("res/drawable-nodpi/file1.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/mipmap-hdpi/frame.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/mipmap-mdpi/frame.png", 472, 290)
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000))
    ...
    public void testMisleadingFileName() {
        ...
        String expected =
                ""
                        ...
                        + "0 errors, 6 warnings\n";
        lint().files(
                        image("res/drawable-mdpi/myjpg.jpg", 48, 48)
                                .format("JPG")
                                .fill(10, 10, 20, 20, 0xFF00FFFF), // VALID
                        image("res/drawable-mdpi/myjpg.jpeg", 48, 48)
                                .format("JPG")
                                .fill(10, 10, 20, 20, 0xFF00FFFF), // VALID
                        image("res/drawable-mdpi/frame.gif", 472, 290)
                                .format("PNG")
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/drawable-mdpi/frame.jpg", 472, 290)
                                .format("PNG")
                                .fill(0xFFFFFFFF)
                                .fill(10, 10, 362, 280, 0x00000000),
                        image("res/drawable-mdpi/myjpg.png", 48, 48)
                                .format("JPG")
                                .fill(10, 10, 20, 20, 0xFF00FFFF),
                        image("res/drawable-mdpi/sample_icon.jpg", 48, 48)
                                .format("GIF")
                                .fill(10, 10, 20, 20, 0xFF00FFFF),
                        image("res/drawable-mdpi/sample_icon.jpeg", 48, 48)
                                .format("GIF")
                                .fill(10, 10, 20, 20, 0xFF00FFFF),
                        image("res/drawable-mdpi/sample_icon.png", 48, 48)
                                .format("GIF")
                                .fill(10, 10, 20, 20, 0xFF00FFFF))
    ...
    public void testColors() {
        ...
        lint().files(
                        ...
                        image("res/drawable-mdpi-v11/ic_stat_my_notification.png", 48, 48)
                                .fill(0xFF00FF30),
                        image("res/drawable-mdpi-v9/ic_stat_my_notification2.png", 48, 48)
                                .fill(0xFF00FF30),
                        image("res/drawable-mdpi/ic_menu_add_clip_normal.png", 32, 32)
    ...
    public void testNotificationIcons() {
        ...
        lint().files(
                        ...
                        image("res/drawable-mdpi/icon3.png", 48, 48)
                                .fill(10, 10, 20, 20, 0xFF00FFFF),
                        image("res/drawable-mdpi/icon4.png", 48, 48)
                                .fill(10, 10, 20, 20, 0xFF00FFFF),
                        image("res/drawable-mdpi/icon5.png", 48, 48)
                                .fill(10, 10, 20, 20, 0xFF00FFFF),
                        image("res/drawable-mdpi/icon6.png", 48, 48)
                                .fill(10, 10, 20, 20, 0xFF00FFFF),
                        // not a notification
                        image("res/drawable-mdpi/icon7.png", 48, 48)
                                .fill(10, 10, 20, 20, 0xFF00FFFF),
                        // ditto
                        image("res/drawable-mdpi/ic_menu_add_clip_normal.png", 32, 32)
                                .fill(10, 10, 20, 20, 0xFFFFFFFF))
    ...
    public void testOkNotificationIcons() {
        lint().files(
                        ...
                        image("res/drawable-mdpi/icon2.png", 32, 32)
                                .fill(10, 10, 20, 20, 0xFFFFFFFF),
                        image("res/drawable-mdpi/icon3.png", 32, 32)
                                .fill(10, 10, 20, 20, 0xFFFFFFFF),
                        image("res/drawable-mdpi/icon4.png", 32, 32)
                                .fill(10, 10, 20, 20, 0xFFFFFFFF),
    ...
    public void testExpectedSizeMipmap() {
        ...
        lint().files(
                        ...
                        // OK sizes
                        image("res/mipmap-xxhdpi/ic_launcher2.png", 144, 144)
                                .fill(10, 10, 20, 20, 0xFF00FFFF))
                .issues(ICON_EXPECTED_SIZE)
                .run()
                .expect(expected);
    ...
    public void testCheckNullDensity() {
        ...
        lint().files(manifest().minSdk(14), image("res/drawable/ic_launcher.png", 24, 24))
                .issues(ICON_EXPECTED_SIZE)
                .run()
                .expectClean();
    }
    ...
    public void testAbbreviate() {
        ...
        lint().files(
                        ...
                        image("res/drawable-mdpi/ic_launcher9.webp", 48, 48)
                                .fill(0xFF00FF25)
                                .format("PNG"),
    ...
    public void testSquareLauncher() {
        ...
        lint().files(
                        ...
                        image("res/drawable-mdpi/ic_launcher_2.png", 50, 40)
    ...
    public void testSquareLauncherFromNonStandardMipmapName() {
        ...
        lint().files(
                        ...
                        image("res/mipmap-mdpi/ic_launcher.png", 50, 40)
                                .text(5, 5, "x", 0xFFFFFFFF)) // OK
                .issues(ICON_LAUNCHER_SHAPE)
                .run()
                .expect(expected);
    }
    ...
    public void testMixNinePatch() {
        ...
        lint().files(
                        ...
                        image("res/drawable-hdpi/ic_launcher_filled.png", 50, 40).fill(0xFFFFFFFF),
                        image("res/drawable-hdpi/ic_launcher_filled.9.png", 50, 40)
                                .fill(0xFFFFFFFF),
                        image("res/drawable-mdpi/ic_launcher_2.png", 50, 40)
                                .text(5, 5, "x", 0xFFFFFFFF))
    ...
    public void test67486() {
        ...
        lint().files(
                        manifest().minSdk(14),
                        base64gzip(
                                "res/drawable-xhdpi/ic_stat_notify.png",
                                ""
    ...
    public void testDuplicatesWithDpNames() {
        ...
        lint().files(
                        image("res/drawable-mdpi/foo_72dp.png", 72, 72)
                                .fill(10, 10, 20, 20, 0x00000000),
                        image("res/drawable-xhdpi/foo_36dp.png", 72, 72)
                                .fill(10, 10, 20, 20, 0x00000000))
    ...
    public void testClaimedSize() {
        ...
        lint().files(
                        image("res/drawable-mdpi/foo_72dp.png", 72, 72)
                                .fill(10, 10, 20, 20, 0x00000000),
                        // ok
                        image("res/drawable-mdpi/foo_80dp.png", 72, 72)
                                .fill(10, 10, 20, 20, 0x00000000),
                        // wrong
                        image("res/drawable-xhdpi/foo_36dp.png", 72, 72)
                                .fill(10, 10, 20, 20, 0x00000000),
                        // ok
                        image("res/drawable-xhdpi/foo_35dp.png", 72, 72)
                                .fill(10, 10, 20, 20, 0x00000000),
                        // ~ok
                        image("res/drawable-xhdpi/foo_30dp.png", 72, 72)
                                .fill(10, 10, 20, 20, 0x00000000)) // wrong
    ...
    public void testClaimedSizeWebp() {
        ...
        lint().files(
                        manifest().minSdk(1),
                        base64gzip(
                                "res/drawable-mdpi/my_lossy_72dp.webp",
                                ""
                                        // Lossy
                                        ...
                                        + "AADVeQHzUAAAAA=="),
                        base64gzip(
                                "res/mipmap-mdpi/my_lossy2_72dp.webp",
                                ""
                                        // Lossy
                                        + "H4sIAAAAAAAAAAvydHPzYGBgCHd1CggLsFCwAbIvMDPMZdSyYrBgsJvoscBH"
                                        + "dYmykhIHwwYhzkyGMgYGhbxlC7g+chcxMPw7vf3/Wx8ht6D//wV23zjUANTK"
                                        + "AADVeQHzUAAAAA=="),
                        base64gzip(
                                "res/drawable-mdpi/my_lossless_72dp.webp",
                                ""
                                        // Lossless
                                        + "H4sIAAAAAAAAAAvydHNTYWBgCHd1CggLsPARB7L1LQ/wMrBf2O/3ddt/RgXF"
                                        + "P/XrXb/Yf2VkAABv2HPZLAAAAA=="))
    ...
    */
    ...
    public void testWebpEligible() {
        ...
        lint().files(
                        manifest().minSdk(18),
                        image("res/drawable-mdpi/random.png", 48, 48)
                                .fill(10, 10, 20, 20, 0xFF00FFFF))
    ...
    public void testWebpUnsupported() {
        ...
        lint().files(
                        ...
                        base64gzip(
                                "res/drawable-mdpi-v15/my_lossy.webp",
                                ""
                                        + "H4sIAAAAAAAAAAvydHPzYGBgCHd1CggLsFCwAbIvMDPMZdSyYrBgsJvoscBH"
                                        + "dYmykhIHwwYhzkyGMgYGhbxlC7g+chcxMPw7vf3/Wx8ht6D//wV23zjUANTK"
                                        + "AADVeQHzUAAAAA=="),
                        ...
                        base64gzip(
                                "res/drawable-mdpi/my_lossy.webp",
                                ""
                                        + "H4sIAAAAAAAAAAvydHPzYGBgCHd1CggLsFCwAbIvMDPMZdSyYrBgsJvoscBH"
                                        + "dYmykhIHwwYhzkyGMgYGhbxlC7g+chcxMPw7vf3/Wx8ht6D//wV23zjUANTK"
                                        + "AADVeQHzUAAAAA=="),
                        ...
                        base64gzip(
                                "res/mipmap-mdpi/my_lossless.webp",
                                ""
                                        + "H4sIAAAAAAAAAAvydHNTYWBgCHd1CggLsPARB7L1LQ/wMrBf2O/3ddt/RgXF"
                                        + "P/XrXb/Yf2VkAABv2HPZLAAAAA=="),
    ...
    private TestFile mActionBarTest =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mNotificationTest =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
