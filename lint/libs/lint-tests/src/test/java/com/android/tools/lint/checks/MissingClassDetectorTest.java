...
public class MissingClassDetectorTest extends AbstractCheckTest {
    ...
    public void testIncrementalInManifest() throws Exception {
        ...
        assertEquals("No warnings.", lintProject(mAndroidManifestWrongRegs, classpath()));
    }
    ...
    public void test() throws Exception {
        ...
        assertEquals(
                ""
                        ...
                        + "        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "5 errors, 0 warnings\n",
                lintProject(mAndroidManifestWrongRegs, mApiCallTest, classpath()));
    }
        ...
        File library2 =
                getProjectDir(
                        ...
                        projectProperties()
                                .library(true)
                                .compileSdk(14)
                                .property("android.library.reference.1", "../RealLibrary"));
        File library =
                getProjectDir(
                        "RealLibrary",
                        // Library project
    ...
    public void testInnerClassPublic() throws Exception {
        ...
        assertEquals(
                ""
                        ...
                        + "    ^\n"
                        + "1 errors, 0 warnings\n",
                lintProject(mAndroidManifestInner, classpath(), mBar, mBar_class));
    }
    ...
    public void testInnerClass2() throws Exception {
        ...
        assertEquals(
                ""
                        ...
                        + "        ^\n"
                        + "1 errors, 0 warnings\n",
                lintProject(mAndroidManifestInner, classpath(), mApiCallTest, mBar));
    }
    ...
    public void testCustomViewNotReferenced() throws Exception {
        ...
        mEnabled = Sets.newHashSet(MISSING, INSTANTIATABLE, INNERCLASS);
        //noinspection all // Sample code
        assertEquals("No warnings.", lintProject(classpath(), mCustomView3, mCustomView3_class));
    }
    ...
    private TestFile mAndroidManifest =
            xml(
                    "AndroidManifest.xml",
                    ""
                            + "<manifest xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mAndroidManifestInner =
            xml(
                    "AndroidManifest.xml",
                    ""
                            + "<manifest xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mAndroidManifestRegs =
            xml(
                    "AndroidManifest.xml",
                    ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mAndroidManifestWrongRegs =
            xml(
                    "AndroidManifest.xml",
                    ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mCustomView3_class =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mFragmentTest =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mFragmentTest$Fragment1 =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mFragmentTest$Fragment2 =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mFragmentTest$Fragment3 =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mFragmentTest$Fragment4 =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mFragmentTest$Fragment5 =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mFragmentTest$Fragment6 =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mFragmentTest$NotAFragment =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mOnClickActivity =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mOnClickActivity_class =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mTestProvider =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mTestProvider_class =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mTestProvider2 =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mTestProvider2_class =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mTestReceiver =
            java(
                    ""
                            + "package test.pkg;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mTestReceiver_class =
            base64gzip(
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mTestService_class =
            base64gzip(
