    ...
    public void test() throws Exception {
        ...
        try {
            ...
            assertEquals(""
                            ...
                            + "    <h2 class=\"mdl-card__title-text\">New Lint Format</h2>\n"
                            + "  </div>\n"
                            + "              <div class=\"mdl-card__supporting-text\">\n"
                            + "This is a new version of Android Lint's HTML report. You can temporarily switch back to the old format by setting the following property in your <code>gradle.properties</code> file:<pre>\n"
                            + "    lint.old-html-style=true\n"
                            + "</pre>\n"
                            + "Please also file a tools bug on <a href=\"http://b.android.com\">http://b.android.com</a> explaining what is wrong with the new format or what it is missing.\n"
                            + "              </div>\n"
                            ...
                            + "<br/>              </div>\n"
                            + "              <div class=\"mdl-card__actions mdl-card--border\">\n"
                            + "<button class=\"mdl-button mdl-js-button mdl-js-ripple-effect\" id=\"card1Link\" onclick=\"hideid('card1');\">\n"
                            + "Dismiss</button>            </div>\n"
                            + "            </div>\n"
                            + "          </section>\n"
