...
public class ManifestDetectorTest extends AbstractCheckTest {
    ...
    public void testMissingApplicationIcon() {
        String expected =
                ""
                        ...
                        + "     ~~~~~~~~~~~\n"
                        + "0 errors, 1 warnings";
        lint().files(mMissing_application_icon, mStrings)
    ...
    public void testGradleOverridesOk() {
        lint().files(mGradle_override, gradle("android {\n}"))
                .issues(ManifestDetector.GRADLE_OVERRIDES)
                .run()
                .expectClean();
    }
    ...
    private TestFile mGradle_override =
            xml(
                    "AndroidManifest.xml",
                    ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mMissing_application_icon =
            xml(
                    "AndroidManifest.xml",
                    ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mMissingusessdk =
            xml(
                    "AndroidManifest.xml",
                    ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
