...
class BlameFileTest {
    ...
    fun test() {
        ...
        val sourceManifest = XmlTestFile.create("app/src/main/AndroidManifest.xml",
    ...
    <application
        ...
        <activity android:name=".MainActivity">
            <intent-filter>
                ...
                .createFile(root)
        val mergedManifest = XmlTestFile.create("app/build/intermediates/manifests/full/debug/AndroidManifest.xml",
                """<?xml version="1.0" encoding="utf-8"?>
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    package="test.pkg.myapplication"
