...
"""
    ...
    fun testMultipleResourceTypes() {
        ...
        // correctly.
        val expected = "src/test/pkg/ResourceTypeTest.java:14: Error: Expected resource of type drawable or string [ResourceType]\n" +
    ...
    fun testAnyRes() {
        ...
        val expected = "src/test/pkg/AnyResTest.java:14: Error: Expected resource identifier (R.type.name) [ResourceType]\n" +
    ...
    fun ignore_testExtensionMethods() {
        ...
        lint().files(
                ...
                .checkMessage({ context, issue, severity, location, message, fixData ->
                    this.checkReportedError(context,
                            issue,
                            severity,
                            location,
                            message,
    ...
    fun testSuppressNames() {
        lint().files(
                ...
                SUPPORT_ANNOTATIONS_CLASS_PATH,
                SUPPORT_ANNOTATIONS_JAR)
                .issues(ResourceTypeDetector.RESOURCE_TYPE,
