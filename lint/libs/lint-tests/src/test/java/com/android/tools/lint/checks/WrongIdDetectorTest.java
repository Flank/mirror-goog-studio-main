...
public class WrongIdDetectorTest extends AbstractCheckTest {
    ...
    public void testBasic() throws Exception {
        assertEquals(
                ""
                        ...
                        + "        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "3 errors, 1 warnings\n",
                lintProject(mLayout1, mLayout2, mIds));
    }
    ...
    public void testSuppressed() throws Exception {
        assertEquals("No warnings.", lintProject(mIgnorelayout1, mLayout2, mIds));
    }

    public void testSuppressedSingleFile() throws Exception {
        assertEquals("No warnings.", lintFiles(mIgnorelayout1));
    }
    ...
    public void testIncremental() throws Exception {
        assertEquals(
                ""
                        ...
                        + "        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "3 errors, 1 warnings\n",
                lintProjectIncrementally("res/layout/layout1.xml", mLayout1, mLayout2, mIds));
    }
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mIgnorelayout1 =
            xml(
