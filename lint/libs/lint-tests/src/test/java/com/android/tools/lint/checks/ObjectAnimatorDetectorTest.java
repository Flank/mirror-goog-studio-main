...
public class ObjectAnimatorDetectorTest extends AbstractCheckTest {
    ...
    public void test() throws Exception {
        ...
        assertEquals(""
                ...
                + "                                       ~~~~~~~\n"
                + "src/test/pkg/AnimatorTest.java:55: Warning: This method is accessed from an ObjectAnimator so it should be annotated with @Keep to ensure that it is not discarded or renamed in release builds [AnimatorKeep]\n"
                + "        public void setProp1(int x) {\n"
                + "                    ~~~~~~~~~~~~~~\n"
                + "    src/test/pkg/AnimatorTest.java:15: ObjectAnimator usage here\n"
                + "src/test/pkg/AnimatorTest.java:58: Warning: This method is accessed from an ObjectAnimator so it should be annotated with @Keep to ensure that it is not discarded or renamed in release builds [AnimatorKeep]\n"
