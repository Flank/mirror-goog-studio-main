...
public class AppCompatCustomViewDetectorTest extends AbstractCheckTest {
    ...
    public void testWarningsForMinSdk20() throws Exception {
        assertEquals(""
                        ...
                        + "                              ~~~~~~\n"
                        + "1 errors, 0 warnings\n",
                lintProject(mTestClass, appCompatJar, manifest().minSdk(20))
        );
    }
    ...
    public void testWarningsForMinSdkVersion22() throws Exception {
        ...
        assertEquals(""
                        ...
                        + "                              ~~~~~~\n"
                        + "1 errors, 0 warnings\n",
                lintProject(mTestClass, appCompatJar, manifest().minSdk(22))
        );
    }
    ...
    protected void checkReportedError(@NonNull Context context, @NonNull Issue issue,
        ...
        assertNotNull("Could not extract message tokens from " + message,
                AppCompatCustomViewDetector.getSuggestedSuperClass(message, TEXT));
        assertNotNull("Could not extract message tokens from " + message,
                AppCompatCustomViewDetector.getSuggestedSuperClass(message, RAW));
    }
