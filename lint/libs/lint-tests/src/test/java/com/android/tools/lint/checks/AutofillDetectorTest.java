...
public class AutofillDetectorTest extends AbstractCheckTest {
    ...
    public void testBelow26WithoutAutofillHints() {
        lint().files(manifest().targetSdk(25), xml("res/layout/autofill.xml",
    ...
    public void testWithAutofillHints() {
        lint().files(manifest().targetSdk(26), xml(
    ...
    public void testWithoutAutofillHints() {
        ...
        lint().files(manifest().targetSdk(26), xml(
                ...
                .verifyFixes()
                .window(2)
                .expectFixDiffs("Fix for res/layout/autofill.xml line 5: Set autofillHints:\n" +
                        "@@ -11 +11\n" +
                        "          android:layout_width=\"match_parent\"\n" +
                        "          android:layout_height=\"wrap_content\"\n" +
