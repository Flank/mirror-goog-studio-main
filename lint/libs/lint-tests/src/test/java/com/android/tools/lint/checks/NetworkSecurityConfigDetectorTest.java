...
public class NetworkSecurityConfigDetectorTest extends AbstractCheckTest {
    ...
    public void testMissingBackupPin() {
        String expected = "" +
                ...
                "0 errors, 1 warnings";
        //noinspection all // Sample code
        lint().files(xml("res/xml/network_config.xml", "" +
                "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                "<network-security-config>\n" +
                "    <domain-config>\n" +
    ...
    public void testTrustAnchorsWithMissingCAResource() {
        ...
        lint().files(
                xml("res/xml/network_config.xml", "" +
                        ...
                        "    </debug-overrides>\n" +
                        "</network-security-config>"))
                .incremental("res/xml/network_config.xml").run().expect(expected);
    }
    ...
    public void testTrustAnchorsWithValidCAResource() {
        ...
        lint().files(
                ...
                xml("res/xml/network_config.xml", "" +
                        ...
                        "    </debug-overrides>\n" +
                        "</network-security-config>"))
                .incremental("res/xml/network_config.xml").run().expectClean();
    }
    ...
    public void testConfigDuplicatesMessage() {
        ...
        String expected = "" +
                ...
                "3 errors, 0 warnings\n";
        lint().files(
                xml("res/xml/network_config_debug.xml", "" +
                        "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                        "<network-security-config>\n" +
                        "    <debug-overrides>\n" +
                        "        <trust-anchors>\n" +
