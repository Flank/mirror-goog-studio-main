...
public class AppIndexingApiDetectorTest extends AbstractCheckTest {
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mAppIndexingApiTestOk =
            java(
                    ""
                            + "package com.example.helloworld;\n"
                            + "\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mApp_indexing_api_test =
            xml(
                    "AndroidManifest.xml",
                    ""
                            + "<manifest xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mAppindexing_manifest =
            xml(
                    "AndroidManifest.xml",
                    ""
                            + "<manifest xmlns:android=\"http://schemas.android.com/apk/res/android\"\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile mGoogleApiClient =
            java(
                    ""
                            + "package com.google.android.gms.common.api;\n"
                            + "\n"
