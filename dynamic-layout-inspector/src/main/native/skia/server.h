...
class SkiaParserServiceImpl final
 ...
 public:
  ::grpc::Status Ping(
      ...
      const ::layoutinspector::proto::PingRequest* request,
      ::layoutinspector::proto::PingResponse* response) override;

  ::grpc::Status Shutdown(
      ::grpc::ServerContext* context,
      const ::layoutinspector::proto::ShutdownRequest* request,
      ::layoutinspector::proto::ShutdownResponse* response) override;
