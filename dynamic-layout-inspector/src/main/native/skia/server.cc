...
::grpc::Status SkiaParserServiceImpl::Ping(
    ::grpc::ServerContext*, const ::layoutinspector::proto::PingRequest*,
    ::layoutinspector::proto::PingResponse*) {
  return ::grpc::Status::OK;
}

::grpc::Status SkiaParserServiceImpl::Shutdown(
    ::grpc::ServerContext*, const ::layoutinspector::proto::ShutdownRequest*,
    ::layoutinspector::proto::ShutdownResponse*) {
  exit_requested.set_value();
  return ::grpc::Status::OK;
}

// V0/1, no support for large messages. Used by studio prior to 2020.3.1
