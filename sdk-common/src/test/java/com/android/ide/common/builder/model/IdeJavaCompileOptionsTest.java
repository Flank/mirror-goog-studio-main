...
import com.android.ide.common.builder.model.stubs.JavaCompileOptionsStub;
...
public class IdeJavaCompileOptionsTest {
    ...
    public void serialization() throws Exception {
        IdeJavaCompileOptions compileOptions =
                new IdeJavaCompileOptions(new JavaCompileOptionsStub(), myModelCache);
    ...
    public void equalsAndHashCode() {
        IdeModelTestUtils.createEqualsVerifier(IdeJavaCompileOptions.class).verify();
    }
}
