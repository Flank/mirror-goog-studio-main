...
import com.android.ide.common.builder.model.stubs.ProductFlavorContainerStub;
...
public class IdeProductFlavorContainerTest {
    ...
    public void serialization() throws Exception {
        ...
        byte[] bytes = Serialization.serialize(container);
    ...
    public void equalsAndHashCode() {
        IdeModelTestUtils.createEqualsVerifier(IdeProductFlavorContainer.class).verify();
    }
}
