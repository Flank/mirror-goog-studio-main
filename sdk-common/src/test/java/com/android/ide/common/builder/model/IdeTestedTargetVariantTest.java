...
import com.android.ide.common.builder.model.stubs.TestedTargetVariantStub;
...
public class IdeTestedTargetVariantTest {
    ...
    public void serialization() throws Exception {
        IdeTestedTargetVariant targetVariant =
                new IdeTestedTargetVariant(new TestedTargetVariantStub(), myModelCache);
    ...
    public void equalsAndHashCode() {
        IdeModelTestUtils.createEqualsVerifier(IdeTestedTargetVariant.class).verify();
    }
}
