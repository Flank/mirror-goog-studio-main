...
import com.android.ide.common.builder.model.stubs.SigningConfigStub;
...
public class IdeSigningConfigTest {
    ...
    public void serialization() throws Exception {
        IdeSigningConfig signingConfig =
                new IdeSigningConfig(new SigningConfigStub(), myModelCache);
    ...
    public void equalsAndHashCode() {
        IdeModelTestUtils.createEqualsVerifier(IdeSigningConfig.class).verify();
    }
}
