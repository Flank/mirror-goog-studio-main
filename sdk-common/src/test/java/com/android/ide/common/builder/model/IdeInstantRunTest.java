...
import com.android.ide.common.builder.model.stubs.InstantRunStub;
...
public class IdeInstantRunTest {
    ...
    public void serialization() throws Exception {
        ...
        byte[] bytes = Serialization.serialize(instantRun);
    ...
    public void equalsAndHashCode() {
        IdeModelTestUtils.createEqualsVerifier(IdeInstantRun.class).verify();
    }
}
