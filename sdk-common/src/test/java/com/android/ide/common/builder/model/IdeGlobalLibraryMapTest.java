...
public class IdeGlobalLibraryMapTest {
    ...
    public void serialization() throws Exception {
        IdeGlobalLibraryMap globalLibraryMap =
                new IdeGlobalLibraryMap(new GlobalLibraryMapStub(), myModelCache);
        byte[] bytes = Serialization.serialize(globalLibraryMap);
    ...
    public void equalsAndHashCode() {
        IdeModelTestUtils.createEqualsVerifier(IdeGlobalLibraryMap.class)
