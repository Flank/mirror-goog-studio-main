...
import com.android.ide.common.builder.model.stubs.VectorDrawablesOptionsStub;
...
public class IdeVectorDrawablesOptionsTest {
    ...
    public void equalsAndHashCode() {
        IdeModelTestUtils.createEqualsVerifier(IdeVectorDrawablesOptions.class).verify();
    }
}
