...
import com.android.ide.common.builder.model.stubs.NativeLibraryStub;
...
public class IdeNativeLibraryTest {
    ...
    public void serialization() throws Exception {
        ...
        byte[] bytes = Serialization.serialize(nativeLibrary);
    ...
    public void equalsAndHashCode() {
        IdeModelTestUtils.createEqualsVerifier(IdeNativeLibrary.class).verify();
    }
}
