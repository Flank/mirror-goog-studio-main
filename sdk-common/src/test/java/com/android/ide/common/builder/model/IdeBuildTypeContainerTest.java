...
import com.android.ide.common.builder.model.stubs.BuildTypeContainerStub;
...
public class IdeBuildTypeContainerTest {
    ...
    public void serialization() throws Exception {
        IdeBuildTypeContainer buildType =
                new IdeBuildTypeContainer(new BuildTypeContainerStub(), myModelCache);
    ...
    public void equalsAndHashCode() {
        IdeModelTestUtils.createEqualsVerifier(IdeBuildTypeContainer.class).verify();
    }
}
