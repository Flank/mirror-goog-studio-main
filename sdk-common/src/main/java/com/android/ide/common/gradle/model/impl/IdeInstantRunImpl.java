...
public final class IdeInstantRunImpl implements IdeInstantRun, Serializable {
    ...
    public IdeInstantRunImpl(@NonNull InstantRun run) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdeInstantRunImpl)) {
            return false;
        }
        IdeInstantRunImpl run = (IdeInstantRunImpl) o;
