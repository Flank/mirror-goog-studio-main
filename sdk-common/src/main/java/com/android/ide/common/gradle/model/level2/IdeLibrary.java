...
public interface IdeLibrary {
     ...
     *
     * <p>This is either a module path for sub-modules (with optional variant name), or a maven
     ...
     *
     * <p>Only valid for Android Library where {@link #getType()} is {@link #LIBRARY_MODULE}
     */
    @Nullable
