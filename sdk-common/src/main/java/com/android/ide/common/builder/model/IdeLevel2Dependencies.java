...
/**
 * The unified dependency interface that should be used in IDE. Both of {@link DependencyGraphs} in
 * 3.0+ models and {@link Dependencies} in pre-3.0 models should be converted to instance
 * implementing this new interface.
 */
public interface IdeLevel2Dependencies {
    /**
     * The list of Android dependencies.
     *
     * <p>This is a flat list that contains direct and transitive dependencies.
     *
     ...
     *
     * <p>This is a flat list that contains module dependencies.
     *
