...
// Capabilities for code swap alone.
const jvmtiCapabilities CODE_SWAP = {
    .can_tag_objects = 0,
    ...
    .can_pop_frame = 0,
    .can_redefine_classes = 1,  // For code swap
    .can_signal_thread = 0,
...
// Capabilities for code and resource swap.
const jvmtiCapabilities CODE_AND_RESOURCE_SWAP = {
    .can_tag_objects = 0,
    .can_generate_field_modification_events = 0,
    .can_generate_field_access_events = 0,
    .can_get_bytecodes = 0,
    ...
    .can_get_monitor_info = 0,
    .can_pop_frame = 0,
    .can_redefine_classes = 1,  // Want to hot swap code
    .can_signal_thread = 0,
    .can_get_source_file_name = 0,
    .can_get_line_numbers = 0,
    .can_get_source_debug_extension = 0,
    .can_access_local_variables = 1,  // Want to intercept message in swap
    .can_maintain_original_method_order = 0,
    .can_generate_single_step_events = 0,
    .can_generate_exception_events = 0,
    .can_generate_frame_pop_events = 0,
    .can_generate_breakpoint_events = 0,
    .can_suspend = 1,  // Want to pause background threads (experimenting)
    .can_redefine_any_class = 0,
    .can_get_current_thread_cpu_time = 0,
    .can_get_thread_cpu_time = 0,
    .can_generate_method_entry_events = 1,  // Want to intercept message in swap
    .can_generate_method_exit_events = 0,
    .can_generate_all_class_hook_events = 0,
    .can_generate_compiled_method_load_events = 0,
    .can_generate_monitor_events = 0,
