...
final class PsdFile_LayersList__ChunkIO {
    static PsdFile.LayersList read(RangedInputStream in, LinkedList<Object> stack) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            rawLayer = PsdFile_RawLayer__ChunkIO.read(in, stack);
        ...
        for (int i = 0; i < size; i++) {
            channelsContainer = PsdFile_ChannelsContainer__ChunkIO.read(in, stack);
