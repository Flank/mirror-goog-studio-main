...
/**
 * An implementation of {@link java.net.HttpURLConnection} which delegates the method calls to a {@link
 ...
 */
public final class HttpURLConnection extends java.net.HttpURLConnection {
    private final TrackedHttpURLConnection myTrackedConnection;

    public HttpURLConnection(java.net.HttpURLConnection wrapped, StackTraceElement[] callstack) {
