...
/**
 * An implementation of {@link javax.net.ssl.HttpsURLConnection} which delegates the method calls to a {@link
 ...
 */
public final class HttpsURLConnection extends javax.net.ssl.HttpsURLConnection {

    private final TrackedHttpURLConnection myTrackedConnection;
    private final javax.net.ssl.HttpsURLConnection myWrappedHttps;

    public HttpsURLConnection(javax.net.ssl.HttpsURLConnection wrapped, StackTraceElement[] callstack) {
        super(wrapped.getURL());
        myTrackedConnection = new TrackedHttpURLConnection(wrapped, callstack);
        myWrappedHttps = wrapped;
    }
