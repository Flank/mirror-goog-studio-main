...
public class MdnsCommandHandler extends HostCommandHandler {
    ...
    @NonNull
    public static final String COMMAND = "mdns";
    ...
    public boolean invoke(
        ...
        try {
            if ("check".equals(args)) {
                CommandHandler.writeOkayResponse(responseSocket.getOutputStream(),
                ...
                CommandHandler.writeFailResponse(responseSocket.getOutputStream(),
                                                 "Invalid mdns command");
            }
        }
    ...
    private String formatMdnsServiceList(List<MdnsService> services) {
        ...
        services.forEach(service -> {
            sb.append(String.format(Locale.US,
                                    ...
                                    service.getIpAddress().getHostAddress(),
                                    service.getPort()));
        });
        return sb.toString();
    }
